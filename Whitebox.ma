...
//Name: Whitebox.ma
//Last modified: Sat, Jan 27, 2024 11:15:15 AM
//Codeset: 1252
requires maya "2024";
...
fileInfo "UUID" "47DF7E82-488F-576E-04A4-EC933A427F19";
createNode transform -s -n "persp";
	rename -uid "47A73D4E-4824-353E-0C18-97997D29F4CE";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 12.918497557624445 14.082367157528299 8.7183535736707523 ;
	setAttr ".r" -type "double3" -25.664389682720184 -304.19999999999976 0 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 21.803016165441189;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "6E9D3D58-4962-2A40-7293-65AC7EF8F36A";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "1EF1151F-4BDE-AAE9-9592-5DAD3C567941";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "72AD0C18-48D7-EEAD-8FE7-F389334F0C11";
createNode displayLayerManager -n "layerManager";
	rename -uid "CAB5B1E2-4408-54F6-284B-EBA626067750";
createNode displayLayer -n "defaultLayer";
	rename -uid "E98A39BB-424E-C76A-8E65-018A2EB195DA";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "30B9AA88-4298-7443-66C9-76811E1957D9";
...
createNode mayaUsdLayerManager -n "mayaUsdLayerManager1";
	rename -uid "E5C4BB89-49B7-408E-52A7-2AB3B00676B5";
