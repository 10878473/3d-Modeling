...
//Last modified: Wed, Jan 24, 2024 04:22:53 PM
//Codeset: 1252
requires maya "2024";
...
fileInfo "UUID" "8566AD9B-4E56-A017-4549-BFB45FBCC9CF";
fileInfo "license" "education";
createNode transform -s -n "persp";
	rename -uid "4ED7FE78-49A5-19D2-F09A-9A94C5830F48";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -88.158035537248338 66.196376956631951 13.642391123633061 ;
	setAttr ".r" -type "double3" -35.864389682737325 -798.99999999997249 -1.6668787942513513e-14 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 113.08609196683254;
...
createNode transform -s -n "top";
	...
	setAttr ".rpt" -type "double3" 3.6105673973535288e-14 2.095474602400113e-14 -2.8648191402282699e-14 ;
createNode camera -s -n "topShape" -p "top";
	rename -uid "DBCC80E0-40CF-5D19-426F-C096C77CB6E9";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".coi" 1000.1000000000009;
	setAttr ".ow" 47.110820893817142;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "A4B0EF3C-4070-479D-4EFA-948563B4E433";
	setAttr -s 2 ".lnk";
	setAttr -s 2 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "E95304E1-4BB6-0168-76F6-13BA7C65B2F4";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "C89571A9-47D6-3C48-0914-E18217465E3D";
createNode displayLayerManager -n "layerManager";
	rename -uid "7EF45740-46F2-5A08-B774-66972FAB491F";
createNode displayLayer -n "defaultLayer";
	rename -uid "DE7D8CB9-414C-C4C9-EC11-00BEF8BAE8AC";
	setAttr ".ufem" -type "stringArray" 0  ;
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "5A803B23-414D-8894-26A3-6E9CC525D730";
